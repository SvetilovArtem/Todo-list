import TodosAfterFilterForAll from "@/components/TodosAfterFilterForAll";
...
const Todos = () => {
  ...
  const todosCompleted = todosFromFirebase
  ...
  const todosAfterFilterNotForAll = todosFromFirebase.filter(
    (todo) => isActiveCategory === todo.category
  );
